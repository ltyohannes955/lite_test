    ...
    try {
      ...
      if (type === "primary") {
        if (data.payload.data && data.payload.data.length > 0) {
          ...
          alert("The location you are trying to set does not exist. Please try again."); // Show alert
        }
      } else {
        if (data.payload.data && data.payload.data.length > 0) {
                      ...
                      <div className="relative mb-4">
                        ...
                        {Array.isArray(pickUp) && pickUp.length > 0 ? (
                          ...
                          hasSearched && ( // Only show message if a search has been attempted
                            <p className="text-red-500">The location you are trying to set does not exist. Please try again.</p>
                          )
                        )}
                      </div>
