  ...
  return (
    <>
      ...
      >
        ...
        >
          LIYT is a modern delivery system for efficient package tracking and
          management.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: -50 }}
        ...
        <div className="w-full py-10 px-4">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-36">
            <p className="text-gray-500 text-center sm:text-lg max-w-lg lg:text-left">
              LIYT simplifies delivery management with real-time tracking and
              seamless integration into your systems. Our developer-friendly API
              makes it easy to incorporate our services into your apps. Whether
              you’re handling small or large deliveries, LIYT scales with your
              business needs. With a focus on security and reliability, we
              ensure timely and safe deliveries, all while offering a
              user-friendly interface that makes managing deliveries effortless.
            </p>
            <Image
